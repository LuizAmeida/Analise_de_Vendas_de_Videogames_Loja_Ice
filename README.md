...
- **NBViewer**: [Clique aqui](https://nbviewer.org/github.com/LuizAlmeida/Analise_de_Vendas_de_Videogames_Loja_Ice/blob/main/notebook.ipynb) para visualizar o notebook diretamente no navegador
- **Google Colab**: [Abrir no Colab](https://colab.research.google.com/github.com/LuizAlmeida/Analise_de_Vendas_de_Videogames_Loja_Ice/blob/main/notebook.ipynb) para executar o notebook na nuvem
